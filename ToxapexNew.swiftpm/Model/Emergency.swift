...
class EmergencyManager {
    ...
    func loadEmergencies(){
        let cprSteps = [
            ...
            EmergencyStep(title: "Safety First", image: "", stepDescription: "Before taking any action, ensure the area is safe for you. Do not put yourself at risk. If the scene is unstable, wait for professional emergency services.", specificAnimation: false, insideSteps: nil),
        ...
        let medicalSteps = [
            ...
            EmergencyStep(title: "Call for Help", image: "", stepDescription: "Call the highway's 0800 number for faster assistance. If unknown, use the emergency services below:", specificAnimation: false, insideSteps: [
                ...
                EmergencyStep(title: "190 (Military Police):", text: "State Highways. Best for official reports and traffic control.", callNumber: "Emergency Contacts")
            ]),
...
//        )
        ...
        self.immediateEmergencies = [
            ...
            Emergency(title: "Victim Extraction", image: "exclamationmark.octagon.fill", steps: medicalSteps, category: 1, color: Color("SevereAccident"), color2: Color("SevereAccident2"))
        ]
